        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                ActivityCompat.requestPermissions(this,
                        new String[]{Manifest.permission.BYDAUTO_BODYWORK_COMMON,}, 1);
            }
        } else {
...
//                //通过空调类的获得风量档位接口获得当前风量档位，获得的值应该设置的值
//                Integer acwindlevel = mAcDevice.getAcWindLevel();
//                mAcWindLevel.setText(String.valueOf(acwindlevel));
//            }
        }
    }
    ...
    public void requestAcCommonPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                //申请权限，字符串数组内是一个或多个要申请的权限，1是申请权限结果的返回参数，在onRequestPermissionsResult可以得知申请结果
                ActivityCompat.requestPermissions(this,
                        new String[]{Manifest.permission.BYDAUTO_AC_COMMON,}, 1);
            }
        } else {
            // 已获得空调类的动态权限，可以获取实例
            if (mAcDevice == null) {
        ...
        if (requestCode == 1) {
            for (int i = 0; i < permissions.length; i++) {
                if (grantResults[i] == PERMISSION_GRANTED) {
                    ...
                    if (permissions[i].equals( Manifest.permission.BYDAUTO_BODYWORK_COMMON)) {
                        if (mBodyworkDevice == null) {
                            //获取车身状态类实例
                            mBodyworkDevice = BYDAutoBodyworkDevice.getInstance(this);
                    ...
                    } else if (permissions[i].equals( Manifest.permission.BYDAUTO_AC_COMMON)) {
                        if (mAcDevice == null) {
                            //获取空调类实例
